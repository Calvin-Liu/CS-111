 ...
 *   start_function becomes the new address of the new thread's instruction poin     ter
*****************************************************************************/
...
/*****************************************************************************
 * Make a function where one process can make another process exit
 * Make all the even number calls kill the odd number calls in mpos-app2.c
 * Except for thread 1
 * This should print out all the process numbers, but only even ones
*****************************************************************************/
